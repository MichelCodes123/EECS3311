...
public class NonFacultyBuilder extends UserBuilder {
	...
	public NonFacultyStaff getUser() {

		return new NonFacultyStaff(id, name, email, password, can_borrow, overdue_charge, is_registered,
				rented_item_list);
