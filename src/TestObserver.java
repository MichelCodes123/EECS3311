...
public class TestObserver {
    ...
    public void testTextbookAvailabilityNotification1() {
        // Create a textbook
        Textbook textbook = new Textbook("1", "Computer Science: An Overview", "Library", true, System.currentTimeMillis(), 50.0);

        // Create a faculty member
        FacultyMember facultyMember = new FacultyMember("1", "John Doe", "john@example.com", "password", true, 0.0, true, new ArrayList<>());
        ...
        assertEquals("Faculty Member Notification: New edition of textbook 'Computer Science: An Overview' is available.", facultyMember.getLastNotification());
    ...
    public void testTextbookAvailabilityNotification2() {
        // Create a textbook
        Textbook textbook = new Textbook("1", "Introduction to Java", "Library A", true, System.currentTimeMillis(), 50.0);

        // Create a faculty member
        FacultyMember facultyMember = new FacultyMember("101", "John Doe", "john@example.com", "password", true, 0.0, true, new ArrayList<>());
        ...
        textbook.setAvailability(true);
        assertEquals("Faculty Member Notification: New edition of textbook 'Introduction to Java' is available.", facultyMember.getLastNotification());
    }

    @Test
    public void testAddObserver() {
        Textbook textbook = new Textbook("1", "Chemistry", "Library", true, null, null);
        FacultyMember facultyMember = new FacultyMember("1", "Jane Smith", "jane@example.com", "password", true, 0.0, true, new ArrayList<>());
    ...
    public void testTextbookUnavailableNotification() {
        // Create a textbook
        Textbook textbook = new Textbook("2", "Data Structures and Algorithms", "Library B", true, System.currentTimeMillis(), 60.0);
        ...
        assertEquals("Library Management Team Notification: Textbook 'Data Structures and Algorithms' is not available.", libraryManagementTeam.getLastNotification());
    }
    ...
    public void testTextbookNotifications() {
        ...
        FacultyMember facultyMember1 = new FacultyMember("1", "John", "john@example.com", "password", true, 0.0, true, new ArrayList<>());
        // FacultyMember facultyMember2 = new FacultyMember("2", "Jane Smith", "jane@example.com", "password", true, 0.0, true, new ArrayList<>());

        // Create a library management team
        LibraryManagementTeam libraryManagementTeam = new LibraryManagementTeam();

        // Create textbooks
        Textbook textbook1 = new Textbook("1", "Computer Science: An Overview", "Library", true, System.currentTimeMillis(), 50.0);
        Textbook textbook2 = new Textbook("2", "Data Structures and Algorithms", "Library", true, System.currentTimeMillis(), 60.0);
        ...
        assertEquals( "Faculty Member Notification: New edition of textbook 'Computer Science: An Overview' is available.",facultyMember1.getLastNotification());
        assertEquals( "Library Management Team Notification: Textbook 'Data Structures and Algorithms' is not available.",libraryManagementTeam.getLastNotification());
    }
}
