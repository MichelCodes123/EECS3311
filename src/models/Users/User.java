...
public abstract class User {
	...
	public User(String id, String name, String email, String password, Boolean can_borrow, Double overdue_charge,
		...
		if (subscribed_newsletters != null && !subscribed_newsletters.isEmpty()
				&& !subscribed_newsletters.contains("")) {
	...
	public void setOverdue_charge(Double charge) {
		this.overdue_charge = charge;
	...
	public void increaseOverdue_charge(Double price) {
		this.overdue_charge = overdue_charge + price;
	}

	public void setCan_borrow(Boolean bool) {
		this.can_borrow = bool;
	}

	public void add_item(String item_id) {
		this.rented_item_list.add(item_id);
	}

	public void add_subscription(String link) {
		this.subscribed_newsletters.add(link);
	}

	public void remove_subscription(String link) {
		this.subscribed_newsletters.remove(link);
	}
